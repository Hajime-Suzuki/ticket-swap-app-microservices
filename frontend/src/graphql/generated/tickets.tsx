...
export type GetTicketsQuery = ({ __typename?: 'Query' } & { getTickets: ({ __typename?: 'GetTicketsResponse' } & { tickets: Array<({ __typename?: 'Ticket' } & Pick<Ticket, 'id' | 'eventId' | 'userId' | 'price' | 'date'>)> }) });
...
export type GetTicketQuery = ({ __typename?: 'Query' } & { getTicket: ({ __typename?: 'GetTicketResponse' } & { ticket: Maybe<({ __typename?: 'Ticket' } & Pick<Ticket, 'id' | 'price' | 'date'>)> }) });
...
export const GetTicketsDocument = gql`
  ...
  getTickets(args: $args) {
    ...
    export function useGetTicketsQuery(baseOptions?: ReactApolloHooks.QueryHookOptions<GetTicketsQueryVariables>) {
      return ReactApolloHooks.useQuery<GetTicketsQuery, GetTicketsQueryVariables>(GetTicketsDocument, baseOptions);
    };
...
export const GetTicketDocument = gql`
  ...
  getTicket(args: {eventId: $eventId, id: $ticketId}) {
    ...
    export function useGetTicketQuery(baseOptions?: ReactApolloHooks.QueryHookOptions<GetTicketQueryVariables>) {
      return ReactApolloHooks.useQuery<GetTicketQuery, GetTicketQueryVariables>(GetTicketDocument, baseOptions);
    };
